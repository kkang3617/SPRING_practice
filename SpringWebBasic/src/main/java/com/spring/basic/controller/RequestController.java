...
public class RequestController {
   ...
   */
	...
	//요청이 들어온 URL값을 뷰 리졸버에게 전닿한다.
	@GetMapping("/join") //void 일때는 return 없으므로 이것이 경로가 됨 //컨트롤러 자체에 공통된 URI 맵핑(request)
	...
	*/
	...
	public void register( String userId,
						  String userPw,
						  @RequestParam(value = "hobby", required = false, defaultValue = "no hooby person") List<String> hobby) {
