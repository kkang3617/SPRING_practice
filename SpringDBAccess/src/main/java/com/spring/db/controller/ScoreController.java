...
public class ScoreController {
	...
	//객체를 자동으로 변수에 주입해 주는 스프링 아노테이션이다.
	//필드, 생성자, setter 메스드에 붙일 수 있다.
	
	// private IscoreService service = new ScoreService();
	@Autowired
	private IScoreService service; //IScoreService 객체에 맞는 객체를 자동으로 찾아줌.
	
	/*
	@Autowired
	public void ScoreController(IScoreService service) {
	...
	*/
	...
	public String register() {
		...
		return "score/write-form"; // score폴더 안에있는 jsp 파일을 열어달라.
	}
	...
	public String register(ScoreVO vo) {
		...
		return "score/write-result"; //score폴더 안에있는 write-result로갈게요
	}
